namespace CalculateFlooringCosts
{
    partial class frmHardwood
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.txtCost, "Cost of hardwood floor per square feet");
            // 
            // label2
            // 
            ...
            // txtArea
            // 
            this.helpProvider1.SetHelpString(this.txtArea, "Area is length in feet x width in feet");
            ...
            this.toolTip1.SetToolTip(this.txtArea, "Area that needs to be covered by the hardwood floor in square feet");
            // 
            // label1
            // 
            ...
            this.toolTip1.SetToolTip(this.rdoStandard, "($2.99 * Area) Cost");
            ...
            this.rdoFloating.Size = new System.Drawing.Size(79, 21);
            this.rdoFloating.TabIndex = 5;
            this.rdoFloating.TabStop = true;
            this.rdoFloating.Text = "Floating";
            this.toolTip1.SetToolTip(this.rdoFloating, "($1.99 * Area) Cost");
            ...
            this.helpProvider1.SetHelpKeyword(this, "This form calculates how much is the cost to have a hardwood floor installation o" +
        "ver a specific area.");
